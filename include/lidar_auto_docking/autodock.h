 ...
 private:
  ...
  /*
    ...
    bool backupDistance() {
      ...
      // The constants are purely arbitrary because they seemed good at the
    time.
    ...
    bool isApproachBad(double& dock_yaw) {
      // Grab the dock pose in the base_link so we can evaluate it wrt the
    robot. geometry_msgs::msg::PoseStamped dock_pose_base_link;
    ...
    { charging_ = true; } else { charging_ = false;
              }
              // Update control
